...
#. Define all custom exceptions in a single module.
   ...
   #. This makes it really easy to observe what custom errors are available. If there
...
#. Create a wrapper to register custom errors.
   ...
   #. Creates a mapping to define all custom FhY exceptions. Furthermore, it also
